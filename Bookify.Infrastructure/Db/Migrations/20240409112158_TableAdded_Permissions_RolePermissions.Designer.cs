...
namespace Bookify.Infrastructure.Db.Migrations
{
    ...
    [Migration("20240409112158_TableAdded_Permissions_RolePermissions")]
    partial class TableAdded_Permissions_RolePermissions
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Bookify.Domain.Users.RolePermissions", b =>
                {
                    b.Property<int>("RoleId")
                        .HasColumnType("integer")
                        .HasColumnName("role_id");
            ...
            modelBuilder.Entity("Bookify.Domain.Bookings.Booking", b =>
                {
                    ...
                    b.OwnsOne("Bookify.Domain.Bookings.Duration", "Duration", b1 =>
                        {
                            b1.Property<Guid>("BookingId")
                                .HasColumnType("uuid")
                                .HasColumnName("id");
